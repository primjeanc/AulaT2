...
{
    class SistemaVendasContext
    {
        public SistemaVendasContext()
        {
            ListaDeVendas = new List<Venda>();// inicia a lista e Aloca em memoria
            #region lista100
            ...
            ListaDeVendas.Add(new Venda() { Id = 86, Carro = "Pellentesque Ultricies Dignissim P.C", Valor = 7971, Quantidade = 15, Data = DateTime.Parse("25/10/2019") });
        ...
        public List<Venda> ListaDeVendasPublica { get{return ListaDeVendas;} }
    }
}
